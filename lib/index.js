...
module.exports = {
  ...
  BADGE: function( {label="",message="", link = "",color="green", style = "plastic", logo = "", logoColor = "violet", labelColor="black"}) {
    return `https://img.shields.io/static/v1?label=${label}&message=${message}&color=${color}&${style}&logo=${logo}&logoColor=${logoColor}&link=${link}&labelColor=${labelColor}`
  },
};
